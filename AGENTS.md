...
- Default: ripgrep for exact/regex; mgrep for conceptual discovery and when exact strings are unknown.
- Token guidance and setup steps live in `docs/mixed-search-strategy.md` and `scripts/setup_mgrep_opencode.sh`.
- For PR summaries, see `docs/github_pr_mgrep_summary.md`.
